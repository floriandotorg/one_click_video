                    ...
                    () =>
                        {
                            ...
                            {
                                case NavigationMode.Forward:
                                    (Application.Current as one_click_video.App).RootFrame.GoForward();
                                    break;

                                case NavigationMode.Back:
                                    (Application.Current as one_click_video.App).RootFrame.GoBack();
                                    break;

                                case NavigationMode.New:
                                    (Application.Current as one_click_video.App).RootFrame.Navigate(this.nextUri);
                                    break;
                            }
